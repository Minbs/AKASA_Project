...
Shader "chanrging"
{
	Properties
	{
		...
		[ASEBegin]_charging_par("charging_par", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _inten * _Color0 * IN.ase_color ).rgb;
				float Alpha = ( IN.ase_color.a * tex2D( _charging_par, texCoord18 ) ).r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( IN.ase_color.a * tex2D( _charging_par, texCoord18 ) ).r;
...
ASEEND*/
//CHKSM=A4D5C06336C3E3995B031994FF5A713205D87AA4