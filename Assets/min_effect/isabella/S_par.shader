		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 color12 = IsGammaSpace() ? float4(1,0.572549,0,0) : float4(1,0.2874408,0,0);
...
/*ASEBEGIN
Version=18935
516;73;981;674;1110.961;583.6736;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-221.1116,-345.7736;Inherit;False;Property;_inten;inten;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D82209699331429F0ADFEC33CC587FB9A2BD3923